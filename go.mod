...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/schemaprocessor v0.102.0
...
replace (
	...
	github.com/golang-migrate/migrate/v4 => github.com/SigNoz/golang-migrate/v4 v4.16.3-0.20240804113726-12e31985130b
